            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <div class="w-lg-500px p-10">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_up_form"
                          data-kt-redirect-url="{{url('/user/dashboard')}}"
                          {{--data-kt-redirect-url="../../demo1/dist/authentication/layouts/corporate/sign-in.html"--}}
                         >
                        <!--begin::Heading-->
                        <div class="text-center mb-11">
                            <!--begin::Title-->
                            <h1 class="text-dark fw-bolder mb-3">User Sign Up</h1>
                            <!--end::Title-->
                            <!--begin::Subtitle-->
...
{{--                            </div>--}}
                        ...
                        <div class="fv-row mb-8" data-kt-password-meter="true">
                            ...
                            <div class="mb-1">
                                ...
                                <div class="position-relative mb-3">
                                    <input class="form-control bg-transparent" type="password" id="password" placeholder="Password"
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <input placeholder="Repeat Password" name="confirm-password" id="confirm_password" type="password"
                                   autocomplete="off" class="form-control bg-transparent"/>
                            <span class="text-danger" id="error_confirm-password"></span>
                            <!--end::Repeat Password-->
                        </div>
                        <!--end::Input group=-->
                        <!--begin::Accept-->
