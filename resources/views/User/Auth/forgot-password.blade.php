...
{{--            <input id="email" type="email" class="block mt-1 w-full rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('email') border-red-500 @enderror" name="email" value="{{ old('email') }}" required autofocus>--}}
{{--            @error('email')--}}
                ...
                <div class="w-lg-500px p-10">
                    ...
                    <form class="form w-100" novalidate="novalidate" method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="fv-row mb-8">
                            <!--begin::Email-->
{{--                                <label for="email" class="block font-medium text-sm text-gray-700">{{ __('Email') }}</label>--}}
                                <input id="email" type="email" class="form-control bg-transparent block mt-1 w-full rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('email') border-red-500 @enderror" name="email" value="{{ old('email') }}" required autofocus>
                                @error('email')
{{--                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>--}}
                                @enderror
{{--                            <input  id="email" type="email"  autocomplete="on" class="form-control bg-transparent" />--}}
                            <!--end::Email-->
                        </div>
                        <!--begin::Actions-->
