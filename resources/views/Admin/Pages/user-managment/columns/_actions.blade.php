...
{{--</a>--}}
<!-- Edit button using Bootstrap classes -->
@role('Manager|Editor|Super Admin', 'admin')
<a href="{{url('/admin/users/edit/'. $user->id )}}" class="btn btn-success">Edit</a>
@endrole
<!-- Delete button using Bootstrap classes -->
@role('Manager|Super Admin', 'admin')
<button class="btn btn-danger" id="delete_row" data-kt-user-id="{{ $user->id }}" >Delete</button>
@endrole
