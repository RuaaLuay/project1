                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                ...
                                <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                    <!--begin::Title-->
                                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Admins List</h1>
                                    <!--end::Title-->
                                    <!--begin::Breadcrumb-->
                                                                ...
                                                                @foreach($roles as $role)
                                                                    <div class="d-flex fv-row">
                                                                        ...
                                                                        <div class="form-check form-check-custom form-check-solid">
                                                                            <!--begin::Input-->
                                                                            <input class="form-check-input me-3" name="user_role" type="radio" value="{{ $role->name }}" id="kt_modal_update_role_option_0" @if($role->name == 'Editor') checked="checked" @endif />
                                                                            <!--end::Input-->
                                                                            <!--begin::Label-->
...
@section('custom-js')
    ...
    <script src="{{ asset('assets/js/custom/apps/admin-management/users/list/table.js') }}"></script>
{{--    <script src="{{ asset('assets/js/custom/apps/user-management/users/list/export-users.js') }} "></script>--}}
    <script src="{{ asset('assets/js/custom/apps/admin-management/users/list/add.js') }}"></script>
