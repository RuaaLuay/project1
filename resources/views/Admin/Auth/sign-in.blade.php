        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                ...
                <div class="w-lg-500px p-10">
                    <!--begin::Form-->
                    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{url('/admin/dashboard')}}"
                          action="admin/login">
                        <!--begin::Heading-->
...
{{--                        </div>--}}
                        ...
                        <div class="fv-row mb-8">
                            ...
                            <span class="text-danger" id="error_email"></span>                            <!--end::Email-->
                        </div>
                        <!--end::Input group=-->
